...
session_start();
error_reporting(0);
include("include_2/connection.php");
...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="../materials/css/style2.css">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-10"
                        style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">
                        <div class="png">
                            <img src="../materials/images/safal.jpg">
                        </div>
                    </div>
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
						...
						<fieldset>
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									...
									<input type="checkbox" onclick="showpass()" class="check mt-2">  show password <br><br>
                                <i class="fa fa-lock"></i>
                            </span><a href="forgot_pass.html">
                                Forgot Password ?
                            </a>
									 </span>
							</div>
					...
					<div class="copyright">
						<span class="text-bold text-uppercase">Safal Multispeciality Hospital</span>
					</div>
