						...
						<div class="row">
							<div class="col-md-12">
								...
								<table class="table table-hover" id="sample-table-1">
									...
									<tbody>
										<?php
										$sql = mysqli_query($conn, "select doctor_reg.fullname as docname,patient_reg.fullname as pname,appointment.*  from appointment join doctor_reg on doctor_reg.doc_username=appointment.doc_username join patient_reg on patient_reg.username=appointment.username ");
										$cnt = 1;
