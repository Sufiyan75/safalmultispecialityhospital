...
if (isset($_POST['update'])) {
	...
	$isread = "Yes";
	$query = mysqli_query($conn, "update tbl_feedback set  admin_remark='$adminremark',is_read='$isread' where feedback_id='$qid'");
	if ($query) {
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Admin | Feedback Details</h1>
							</div>
					...
					<div class="container-fluid container-fullw bg-white">
						...
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15"><span class="text-bold">Feedback
										Details</span></h5>
								<hr />
								<table class="table table-hover" id="sample-table-1">
									...
									<tbody>
										<?php
										$qid = intval($_GET['id']);
										$sql = mysqli_query($conn, "select * from tbl_feedback where feedback_id='$qid'");
										$cnt = 1;
