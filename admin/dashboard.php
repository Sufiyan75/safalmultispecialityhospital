							...
							<div class="col-sm-4">
								<div class="panel panel-white no-radius text-center">
									<div class="panel-body">
										...
										<h2 class="StepTitle">Online Patient</h2>

										<p class="links cl-effect-1">
											<a href="manage-onl-patient.php">
												<?php $result = mysqli_query($conn, "SELECT * FROM `patient_reg`");
									...
									<div class="panel-body">
										...
										<p class="cl-effect-1">
											<a href="manage-doctors.php">
												<?php $result1 = mysqli_query($conn, "SELECT * FROM `doctor_reg`");
								...
								<div class="panel panel-white no-radius text-center">
									<div class="panel-body">
										<span class="fa-stack fa-2x"> <i
												class="fa fa-square fa-stack-2x text-primary"></i> <i
												class="fa fa-smile-o fa-stack-1x fa-inverse"></i> </span>
										<h2 class="StepTitle">Offline Patient</h2>
									...
									<div class="panel-body">
										...
										<p class="links cl-effect-1">
												<a href="unread-queries.php">
													<?php
													$sql = mysqli_query($conn, "SELECT * FROM `tbl_feedback` where  is_read = 'No' AND `feedback_status` = 'active'");
