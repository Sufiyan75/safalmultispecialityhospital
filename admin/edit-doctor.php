...
if (isset($_POST['submit'])) {
	...
	$sql = mysqli_query($conn, "Update doctor_reg set fullname = '$fullname', doc_username = '$doc_username',  specialization='$specialization', fees = '$fees', address='$address', phonenumber='$doccontactno',email='$docemail' where doctor_id='$did'");
	if ($sql) {
									...
									<div class="col-lg-8 col-md-12">
										<div class="panel panel-white">
											...
											<div class="panel-body">
												...
												$sql = mysqli_query($conn, "select * from doctor_reg where `doctor_id`='$did'");
												while ($data = mysqli_fetch_array($sql)) {
													...
													<p><b>Profile Reg. Date: </b>
														<?php echo htmlentities($data['created_at']); ?>
													</p>
													...
													<form role="form" name="adddoc" method="post"
														...
														<div class="form-group">
															...
															<input type="text" name="doc_username" class="form-control" readonly
																value="<?php echo htmlentities($data['doc_username']); ?>">
														</div>
														<div class="form-group">
															...
															<select name="specialization" class="form-control"
																...
																<?php $ret = mysqli_query($con, "select * from `doctor_reg` where specialization = '". $data['specialization'] ." '");
														...
														<div class="form-group">
															...
															<input type="text" name="fees" class="form-control"
																required="required"
																value="<?php echo htmlentities($data['fees']); ?>">
														</div>
														...
														<div class="form-group">
															...
															<input type="text" name="doccontact" class="form-control"
																required="required"
																value="<?php echo htmlentities($data['phonenumber']); ?>">
														</div>
