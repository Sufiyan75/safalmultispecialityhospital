...
<head>
	<title>ADMIN | Patient Medical Record</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">ADMIN | Patient Medical Record</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>ADMIN</span>
					...
					<div class="container-fluid container-fullw bg-white">
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15"><span class="text-bold">View Patient's Medical Record</span>
								</h5>
								<?php
								$vid = $_GET['viewid'];
