...
define("EWR_PROJECT_ID", "{E0F5D537-8F60-4274-BE39-C779902C3A31}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "Safal_report", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "hospital", "qs" => "`", "qe" => "`");
...
// General
$EWR_ROOT_RELATIVE_PATH = "..\..\..\..\Users\admin\OneDrive\Documents\PHPReportMaker\WebSites\Safal_report"; // Relative path of app root
define("EWR_UNFORMAT_YEAR", 50, TRUE); // Unformat year
define("EWR_RANDOM_KEY", 'selDDILMTPkaf7uM', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/Safal_report.css", TRUE); // Project stylesheet file name
