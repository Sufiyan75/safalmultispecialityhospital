...
$app_patient_cnt = NULL;

//
// Table class for app_patient_cnt
//
class crapp_patient_cnt extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'app_patient_cnt';
		$this->TableName = 'app_patient_cnt';
		$this->TableType = 'VIEW';
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// app_id
		$this->app_id = new crField('app_patient_cnt', 'app_patient_cnt', 'x_app_id', 'app_id', '`app_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// username
		$this->username = new crField('app_patient_cnt', 'app_patient_cnt', 'x_username', 'username', '`username`', 200, EWR_DATATYPE_STRING, -1);
		$this->username->Sortable = TRUE; // Allow sort
		$this->fields['username'] = &$this->username;
		$this->username->DateFilter = "";
		$this->username->SqlSelect = "SELECT DISTINCT `username`, `username` AS `DispFld` FROM " . $this->getSqlFrom();
		$this->username->SqlOrderBy = "`username`";

		// doc_username
		$this->doc_username = new crField('app_patient_cnt', 'app_patient_cnt', 'x_doc_username', 'doc_username', '`doc_username`', 200, EWR_DATATYPE_STRING, -1);
		...
		// specialization
		$this->specialization = new crField('app_patient_cnt', 'app_patient_cnt', 'x_specialization', 'specialization', '`specialization`', 200, EWR_DATATYPE_STRING, -1);
		...
		// fees
		$this->fees = new crField('app_patient_cnt', 'app_patient_cnt', 'x_fees', 'fees', '`fees`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// date
		$this->date = new crField('app_patient_cnt', 'app_patient_cnt', 'x_date', 'date', '`date`', 133, EWR_DATATYPE_DATE, 0);
		...
		// time
		$this->time = new crField('app_patient_cnt', 'app_patient_cnt', 'x_time', 'time', '`time`', 200, EWR_DATATYPE_STRING, -1);
		...
		// reason
		$this->reason = new crField('app_patient_cnt', 'app_patient_cnt', 'x_reason', 'reason', '`reason`', 200, EWR_DATATYPE_STRING, -1);
		...
		// postingDate
		$this->postingDate = new crField('app_patient_cnt', 'app_patient_cnt', 'x_postingDate', 'postingDate', '`postingDate`', 135, EWR_DATATYPE_DATE, 0);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`app_patient_cnt`";
	}
	...
	function getSqlSelectAgg() {
		return ($this->_SqlSelectAgg <> "") ? $this->_SqlSelectAgg : "SELECT COUNT(*) AS `cnt_username` FROM " . $this->getSqlFrom();
	}
