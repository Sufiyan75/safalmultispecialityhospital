...
//
// Table class for app_bet_dates
//
class crapp_bet_dates extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'app_bet_dates';
		$this->TableName = 'app_bet_dates';
		$this->TableType = 'VIEW';
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// app_id
		$this->app_id = new crField('app_bet_dates', 'app_bet_dates', 'x_app_id', 'app_id', '`app_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// username
		$this->username = new crField('app_bet_dates', 'app_bet_dates', 'x_username', 'username', '`username`', 200, EWR_DATATYPE_STRING, -1);
		...
		// doc_username
		$this->doc_username = new crField('app_bet_dates', 'app_bet_dates', 'x_doc_username', 'doc_username', '`doc_username`', 200, EWR_DATATYPE_STRING, -1);
		...
		// specialization
		$this->specialization = new crField('app_bet_dates', 'app_bet_dates', 'x_specialization', 'specialization', '`specialization`', 200, EWR_DATATYPE_STRING, -1);
		...
		// fees
		$this->fees = new crField('app_bet_dates', 'app_bet_dates', 'x_fees', 'fees', '`fees`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// date
		$this->date = new crField('app_bet_dates', 'app_bet_dates', 'x_date', 'date', '`date`', 133, EWR_DATATYPE_DATE, 0);
		...
		// time
		$this->time = new crField('app_bet_dates', 'app_bet_dates', 'x_time', 'time', '`time`', 200, EWR_DATATYPE_STRING, -1);
		...
		// reason
		$this->reason = new crField('app_bet_dates', 'app_bet_dates', 'x_reason', 'reason', '`reason`', 200, EWR_DATATYPE_STRING, -1);
		...
		// postingDate
		$this->postingDate = new crField('app_bet_dates', 'app_bet_dates', 'x_postingDate', 'postingDate', '`postingDate`', 135, EWR_DATATYPE_DATE, 0);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`app_bet_dates`";
	}
	...
	function getSqlSelectAgg() {
		return ($this->_SqlSelectAgg <> "") ? $this->_SqlSelectAgg : "SELECT COUNT(*) AS `cnt_date` FROM " . $this->getSqlFrom();
	}
