                            ...
                            <ol class="breadcrumb">
                                <li>
                                    <span>
                                        ...
                                        $fname = $_SESSION['fullname'];
                                        echo $fname;
                                        $sql = "SELECT * FROM `patient_reg` WHERE `fullname` = '$fname'";
                                        $result = mysqli_query($conn, $sql);
                                        while($data = mysqli_fetch_assoc($result)){
                                            $_SESSION['patietn_u'] = $data['username'];
                                        }
                                        ?>
                                    </span>
                                </li>
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        <div class="row">
                            ...
                            <h5 style="color: green; font-size:18px; ">
                                <?php if($msg_1) { echo htmlentities($msg_1);}?> </h5>
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <div class="panel panel-white">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                $patietn_u = $_SESSION['patietn_u'];
                                                $sql = "Select * FROM `patient_reg` WHERE `username` = '$patietn_u'";
                                                $result = mysqli_query($conn, $sql);
                                                while ($data = mysqli_fetch_assoc($result)) {
                                                    echo "<b>Registered Date</b>: " . $data['reg_at'] . "&emsp;";
                                                    echo "<b>Last Updation Date</b>: " . $data['updationDate'];
                                                    $_SESSION['p_id'] = $data['patient_id'];
                                                }
                                                ?>
                                                <div>
                                                    <hr>
                                                    <form action="edit_profile_2.php" role="form" name="edit" id="edit" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="fullname" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode == 32)" name="fullname" class="form-control" 
                                                            value="<?php
                                                                $sql = "SELECT * FROM `patient_reg` WHERE `fullname` = '$fname'";
                                                                $result = mysqli_query($conn, $sql);
                                                                while($data = mysqli_fetch_assoc($result)){
