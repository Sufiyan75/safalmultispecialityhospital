                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    <tbody>
                                        <?php
                                        $doc_uname = $_SESSION['doctor_uname'];
                                        $sql = mysqli_query($conn, "SELECT * FROM `tblpatient` WHERE `doc_username`='$doc_uname' ");
                                        $cnt = 1;
                                        while ($row = mysqli_fetch_array($sql)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit-patient.php?editid=<?php echo $row['Patient_id']; ?>">
                                                    <i class="fa fa-edit"></i></a> || 
                                                    <a href="view-patient.php?viewid=<?php echo $row['Patient_id']; ?>">
