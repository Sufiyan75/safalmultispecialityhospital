		...
		<ul class="nav navbar-right">
			...
			<li class="dropdown current-user">
				...
				<?php 
					...
					$sql = "SELECT `profilepic` FROM `doctor_reg` WHERE `doc_username`= '$uname'";
					...
					<img src="../authentication/registration/picture/<?php echo $row['profilepic']; ?>" width="100" height="50" class="img-thumbnail" alt="No Image Found"> <span class="username">
						<?php
							$sql = "SELECT `fullname` FROM `doctor_reg` WHERE `doc_username`= '$uname'";
							$result = mysqli_query($conn, $sql);
				...
				<ul class="dropdown-menu dropdown-dark">
					<li>
						<a href="../doctor/doc_edit_profile.php">
							My Profile
						</a>
					</li>
					...
					<li>
						<a href="../authentication/logout/doc_log_out.php">
							Log Out
						</a>
					</li>
				</ul>
