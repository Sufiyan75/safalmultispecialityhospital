...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($conn, "INSERT `tblmedicalhistory`(`Patient_id`, `BloodPressure`, `BloodSugar`, `Weight`, `Temperature`, `MedicalPres`) VALUES ('$vid', '$bp', '$bs', '$weight', '$temp', '$pres')");
    if ($query) {
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php
                                $vid = $_GET['viewid'];
                                $ret = mysqli_query($conn, "SELECT * FROM `tblpatient` WHERE `Patient_id`='$vid'");
                                $cnt = 1;
                                while ($row = mysqli_fetch_array($ret)) {
                                    $_SESSION['patient_fn'] = $row['PatientName'];
                                    ?>
                                    ...
                                    <?php
                                        $ret = mysqli_query($conn, "SELECT * FROM `tblmedicalhistory` WHERE `Patient_id` = '$vid'");
                                    ?>
